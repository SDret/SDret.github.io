  ...
  more_info: >
    ...
    <p>
      <a href="mailto:ybzhou@buaa.edu.cn">
        <i class="fa-solid fa-envelope"></i> ybzhou@buaa.edu.cn
      </a>
    </p>
...
<div class="yibo-links" role="navigation" aria-label="Academic profiles">
  <a class="yibo-link" href="mailto:ybzhou@buaa.edu.cn">
    <i class="fa-solid fa-envelope"></i>
    Email
  </a>

  <a class="yibo-link"
     href="https://scholar.google.com/citations?user=Ch18_eIAAAAJ"
     target="_blank"
  ...
  <a class="yibo-link"
     href="https://orcid.org/0000-0001-7964-7517"
     target="_blank"
     rel="noopener noreferrer">
  ...
  <a class="yibo-link" href="{{ '/cv/' | relative_url }}">
...
<div class="yibo-grid">
  ...
  <div class="yibo-card">
    ...
    <p><strong>M.S. in Electrical Engineering</strong></p>
    <p>August 2017 – May 2019</p>
    <p>San Diego, California, USA</p>
  </div>

  <div class="yibo-card">
    <h3>Lanzhou University</h3>
    <p><strong>B.S. in Materials Physics</strong></p>
    <p>August 2013 – June 2017</p>
    <p>Lanzhou, China</p>
  </div>
</div>
...
<div class="yibo-card yibo-experience-card">
  <h3>OPPO Guangdong Mobile Telecommunications Corp., Ltd.</h3>
  <p><strong>Artificial Intelligence Algorithm Engineer</strong></p>
